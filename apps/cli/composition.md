...
flowchart LR
  ...
  plugin_dsh_base_llm_gateway_presets["llm-gateway-presets<br/>@deepseek-ai/dsh-llm-gateway-presets"]
  cfg --> plugin_dsh_base_llm_gateway_presets
...
| `llm-gateway-presets` | `@deepseek-ai/dsh-llm-gateway-presets` |
