...
export const en = {
  ...
  probing: 'Probing the picked models\u2026',
  probeNoteProbed: 'Probed thinking levels: {summary}',
  probeNoteNone: 'No thinking levels were confirmed for the picked models.',
  probeNoteFailed: 'Capability probing failed: {message} \u2014 added without thinking levels.',
  probeDeveloperFixed: 'This endpoint rejects the developer role; the profile pins supportsDeveloperRole automatically.',
  probeModels: 'Probe these models',
  probeModelsBusy: 'Probing these models\u2026',
  probeModelsNeedsRows: 'Add a model with an ID first, then probe.',
  probeRowsNone: 'No thinking levels were confirmed for these models.',
  probeRowsFailedModels: 'Not probed: {summary}',
  probeRowsFailed: 'Capability probing failed: {message} \u2014 rows keep their current settings.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  fetchAdopt: '添加所选',
  probing: '正在探测所选模型的能力\u2026',
  probeNoteProbed: '已探测思考档位：{summary}',
  probeNoteNone: '未能确认所选模型支持思考档位。',
  probeNoteFailed: '能力探测失败：{message} \u2014 已按无思考档位添加。',
  probeDeveloperFixed: '该端点拒绝 developer 角色，已自动在 profile 中钉住 supportsDeveloperRole。',
  probeModels: '探测所选模型',
  probeModelsBusy: '正在探测所选模型\u2026',
  probeModelsNeedsRows: '请先添加带 ID 的模型，再探测。',
  probeRowsNone: '未能确认这些模型支持思考档位。',
  probeRowsFailedModels: '未能探测：{summary}',
  probeRowsFailed: '能力探测失败：{message} \u2014 各模型行保持现有设置。',
  customAdd: '添加自定义提供方',
  customTitle: '自定义提供方',
  customTag: '自定义',
  customRoute: 'Provider ID',
